...
public class bibfsUGOutputFormat extends
		TextVertexOutputFormat<IntWritable, bibfsWritable, NullWritable> {
	...
	public TextVertexWriter createVertexWriter(TaskAttemptContext context) {
		return new bibfsUGVertexWriter();
	}

	/**
	 * Vertex writer used with {@link IdWithValueTextOutputFormat}.
	 */
	protected class bibfsUGVertexWriter extends TextVertexWriterToEachLine {
		/** Saved delimiter */
		private String delimiter = "\t";

		@Override
		protected Text convertVertexToLine(
				Vertex<IntWritable, bibfsWritable, NullWritable, ?> vertex)
				throws IOException {
